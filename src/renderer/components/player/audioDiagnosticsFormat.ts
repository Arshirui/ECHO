...
export const formatAudioDiagnostics = (diagnostics: AudioDiagnostics): string => {
  const rows: Array<[string, unknown]> = [
    ...
    ['echoSrcMode', diagnostics.echoSrcMode],
    ['echoSrcQualityProfile', diagnostics.echoSrcQualityProfile],
    ['echoSrcTargetSampleRate', diagnostics.echoSrcTargetSampleRate],
    ['echoSrcActive', diagnostics.echoSrcActive],
