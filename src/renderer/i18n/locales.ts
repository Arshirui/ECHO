...
const zhCN: TranslationMap = {
  ...
  'settings.integrations.accounts.spotify.description': '官方播放器接入，需要 Premium；请在 Spotify Dashboard 注册 http://127.0.0.1:43879/spotify/callback。',
...
const zhTW: TranslationMap = {
  ...
  'settings.integrations.accounts.spotify.description': '官方播放器接入，需要 Premium；請在 Spotify Dashboard 註冊 http://127.0.0.1:43879/spotify/callback。',
...
const jaJP: TranslationMap = {
  ...
  'settings.integrations.accounts.spotify.description': '公式プレイヤー連携です。Premium が必要で、Spotify Dashboard に http://127.0.0.1:43879/spotify/callback を登録してください。',
...
const enUS: TranslationMap = {
  ...
  'settings.integrations.accounts.spotify.description': 'Official player integration. Premium is required; register http://127.0.0.1:43879/spotify/callback in the Spotify Dashboard.',
